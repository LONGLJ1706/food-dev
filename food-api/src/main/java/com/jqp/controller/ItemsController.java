...
import com.jqp.pojo.Items;
import com.jqp.pojo.ItemsImg;
import com.jqp.pojo.ItemsParam;
import com.jqp.pojo.ItemsSpec;
import com.jqp.service.ItemsService;
import com.jqp.vo.CommentLevelCountsVO;
import com.jqp.vo.ItemInfoVO;
...
public class ItemsController extends BaseController{
    ...
    public JSONResult search(
        ...
        PagedGridResult grid = itemsService.searhItems(keywords, sort, page, pageSize);
        return JSONResult.ok(grid);
    }
    ...
    public JSONResult catItems(
        ...
        PagedGridResult grid = itemsService.searhItems(catId, sort, page, pageSize);
        return JSONResult.ok(grid);
    }
    ...
    public JSONResult refresh(
            @ApiParam(name = "itemSpecIds", value = "拼接的规格ids", required = true,
                    example = "1001,1003,1005") @RequestParam String itemSpecIds) {
